                        ...
                        <div className="mt-1.5 flex flex-col items-center justify-between text-text">
                          ...
                          <div className="col-span-12 text-center w-full mt-3">
                            ...
                            href={"/products/" + product._id}
                              className="disabled block rounded-md bg-orange-400 px-5 py-3 text-md text-white w-full transition hover:bg-purple-300"
                            >
                              Contact For Price
                            </Link>
                          </div>
...
//                     <div className="mt-1.5 flex flex-col   items-center justify-between text-text">
//                       <p className="tracking-wide text-primary text-sm md:text-md">ZAR {formatPrice(product.price)}</p>
